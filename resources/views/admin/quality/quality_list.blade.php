    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        ...
        <div
            ...
            <div class="d-flex align-content-center flex-wrap gap-4 mt-2 mt-md-0">
                ...
                <a href="{{ route('quality-add-edit', 'add') }}" role="button" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table class="datatables-products table dataTable dtr-column collapsed mt-3" id="myTable"
                            ...
                            <tbody>
                                ...
                                @if(!empty($quality_data) && count($quality_data) != 0)

                                    @foreach ($quality_data as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                {{-- Edit --}}
                                                <a href="{{ route('quality-add-edit', $item->id) }}" role="button"
                                                ...
                                                {{-- Delete --}}
                                                <a href="{{ route('quality-delete', $item->id) }}" class="btn btn-danger p-0"
                                                    onclick="confirmDelete(event, '{{ route('quality-delete', $item->id) }}')">

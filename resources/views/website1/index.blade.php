    ...
    <div class="carousel-inner">
        ...
        @empty
            <div class="carousel-item active">
                <img src="{{ asset('assets/images/default-slider.jpg') }}" class="d-block w-100" alt="No Slider Found">
            </div>
        @endforelse
    </div>
    ...
    <div class="hero-container">
        <div class="work-process__container">
            <div class="case-studies__heading">
                <div class="sub-heading-container text-center">TRUSTED BY SURGEONS. CHOOSEN FOR LIFE.</div>
            ...
            <div class="work-process__grid pt-5">
                <div class="work-process__item animation-box anim-fast anim-delay-none" data-animation="fade-down">
                    ...
                    <h5>PREMIUM QUALITY <br> IMPLANTS</h5>
                </div>
                ...
                <div class="work-process__item animation-box anim-normal anim-delay-md" data-animation="fade-down">
                    ...
                    <h5>TRUSTED BY 500+ <br> SURGEONS</h5>
                </div>
                ...
                <div class="work-process__item animation-box anim-slow anim-delay-md" data-animation="fade-down">
                    ...
                    <h5>PRESENCE IN 20+ <br> COUNTRIES</h5>
                </div>
            </div>
        </div>
    </div>
...
<section class="expertise-section">
    <div class="expertise-left">
        <div class="case-studies__heading">
            <div class="sub-heading-container">OUR PRODUCT EXPERTISE</div>
            <div class="sub-heading-divider-product"></div>
        </div>

        <div class="product-grid">
            <div class="product-card">
                <img src="{{ asset('assets/images/home-products/lower-limb.png') }}" alt="Lower Limb">
                <p><a href="lower-limb.html">Lower Limb</a></p>
            </div>

            <div class="product-card">
                <img src="{{ asset('assets/images/home-products/spine-implants.png') }}" alt="Spine Implants">
                <p><a href="spine-implants.html">Spine Implants</a></p>
            </div>

            <div class="product-card">
                <img src="{{ asset('assets/images/home-products/bone-screw.png') }}" alt="Bone Screw">
                <p><a href="#">Bone Screw</a></p>
            </div>

            <div class="product-card">
                <img src="{{ asset('assets/images/home-products/external-fixator.png') }}" alt="External Fixator">
                <p><a href="#">External Fixator</a></p>
            </div>

            <div class="product-card">
                <img src="{{ asset('assets/images/home-products/hip-prosthesis.png') }}" alt="Hip Prosthesis">
                <p><a href="#">Hip Prosthesis</a></p>
            </div>
        </div>
        <a href="#" class="explore-btn">EXPLORE ALL PRODUCTS</a>
    </div>
    ...
    <div class="mission-right">
        ...
        <div class="mission-content">
            <div class="sub-heading-container text-white">OUR MISSION</div>
            <div class="sub-heading-divider-product-line"></div>
            <p>To advance orthopedic care through innovation, precision, and a deep commitment to improving patient lives.</p>
    ...
    <div class="hero-container">
        <div class="contact-cta__container">
            <div class="d-flex flex-column flex-gap-2">
                <div class="sub-heading-container text-white text-center">Partnering in Better Outcomes</div>
                <p class="text-center">We work closely with surgeons and healthcare professionals to shape the future of orthopaedic care.</p>
            </div>
        </div>
    </div>
</section>
